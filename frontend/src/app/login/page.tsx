      ...
      <div className="w-full max-w-md">
        <div className="card bg-card p-8 rounded-lg border-2 border-border shadow-lg">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground">Storage App</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="input w-full bg-background border-2 border-input px-3 py-2 rounded-md focus:border-emerald-500 focus:outline-none"
              />
            </div>
